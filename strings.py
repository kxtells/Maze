...
CP3 = ["Third One!"]
CP4 = ["Fourth One!","One More to Go baby!"]
CP5 = ["Fifth one One!", "Go for it!","The GOAL is waiting","Warm Goal waiting"]
CHPSTRINGS = [CP1,CP2,CP3,CP4,CP5]

D0 = ["Early Death!","You don't even tried","Not even a Checkpoint eh.."]
D1 = ["At least you tried","Well, is no that bad","You learnt something?"]
...
D5 = ["Oh Shit!","I hate you","Oh no! not again","Having Fun?"]
